...
class _InterestsScreenState extends State<InterestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print('InterestsScreen build: allGenres length = ${provider.allGenres.length}, isLoading = ${provider.isLoading}, error = ${provider.error}');
    return Scaffold(
      ...
      body: provider.isLoading
          ...
          : Column(
              children: [
                ...
                Expanded(
                  child: provider.allGenres.isEmpty
                      ? const Center(child: Text('No genres available.'))
                      : (() {
                          final children = provider.allGenres.isNotEmpty
                              ? provider.allGenres
                          ...
                          print('ListView children count: ${children.length}');
